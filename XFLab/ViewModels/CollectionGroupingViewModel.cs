...
{
    public class CollectionGroupingViewModel
    {
        bool includeEmptyGroups;
        public List<AnimalGroup> Animals { get; private set; } = new List<AnimalGroup>();

        public CollectionGroupingViewModel(bool emptyGroups = false)
        {
        ...
        void CreateAnimalsCollection()
        {
            if (includeEmptyGroups)
                Animals.Add(new AnimalGroup("Aardvarks", new List<Monkey>()));

            Animals.Add(new AnimalGroup("Bears", new List<Monkey>
            {
                new Monkey
                {
            ...
            Animals.Add(new AnimalGroup("Cats", new List<Monkey>
            {
                new Monkey
                {
                    Name = "Abyssinian",
            ...
            Animals.Add(new AnimalGroup("Dogs", new List<Monkey>
            {
                new Monkey
                {
                    Name = "Afghan Hound",
            ...
            Animals.Add(new AnimalGroup("Elephants", new List<Monkey>
            {
                new Monkey
                {
            ...
            if (includeEmptyGroups)
                Animals.Add(new AnimalGroup("Horses", new List<Monkey>()));

            Animals.Add(new AnimalGroup("Monkeys", new List<Monkey>
            {
                new Monkey
                {
                    Name = "Baboon",
